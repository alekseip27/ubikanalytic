        ...
        document.querySelector('#vserror').style.display = 'flex';
                ...
                function updateChartWithPrimaryAndPreferred() {
                    ...
                    // Align primary data before fetching preferred data
                    ...
                    // Update the chart with the primary data first
                    ...
                    let prefSections = {
                        pref1: events.pref_section1,
                        pref2: events.pref_section2,
                        pref3: events.pref_section3
                    };
                    ...
                    .then(data => {
                        ...
                        if (data.count === 0) {
                            console.log("No preferred data available.");
                            // Only the primary data will be displayed, return without further updates
                            document.querySelector('#tmloader').style.display = 'none';
                            document.querySelector('#tmerror').style.display = 'none';
                            document.querySelector('#tmchart').style.display = 'flex';
                            return; 
                        ...
                        // Align and update the preferred data with the primary
                        ...
                        // Update chart with combined dates and preferred data
                        chart.config.data.labels = combinedDates;
                        chart.data.datasets[0].data = alignedPrimaryData;
                        chart.update();
        ...
        function processTicketmasterData(data) {
            ...
            data.forEach(event => {
                event.summaries.forEach(summary => {
                    ...
                    if (totalAmount > 0) {
                        ...
                        // Process for preferred section 1
            ...
            // Ensure primary dataset is always updated
            chart.data.datasets = [{
