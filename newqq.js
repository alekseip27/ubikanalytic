    ...
    window.location.assign("https://www.ubikanalytic.com/buy-event?id=" + events.i)
    });
    ...
    window.location.assign("https://www.ubikanalytic.com/error-respond?id=" +encodeURIComponent(events.event_id).replace('%20','+'));
    })}
